    ...
    <div class="shadow-lg shadow-gray-100">
        <nav class="bg-white py-2 flex justify-center">
            <ul>
                <li>
                    <a href="home">
                        <img src="private/assets/images/BMCCA_logo.png" alt="bmcca" class="">
                    </a>
                </li>
            </ul>
        </nav>
            ...
            <form action="" method="post" id="bonafide_form" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-4 mt-8 gap-x-10">
                    ...
                    <div class="row-span-2 flex flex-col gap-y-1 ">
                        ...
                        <input readonly required class="bg-white h-12 rounded-lg pl-2 text-lg outline-none focus:ring-2 focus:ring-indigo-800 cursor-not-allowed" type="text" name="course" id="Course" value="<?php if (isset($crs)) {
