        ...
        xl:px-12 mx-5 rounded-xl" style="background: linear-gradient(-45deg, #e3ffe7 0%, #d9e7ff 100%);">
            ...
            <form action="" method="post" id="document_form" enctype="multipart/form-data">
                <div class="grid grid-rows-20 sm:grid-cols-2 sm:gap-x-6 mt-4 gap-y-3 xl:gap-x-10 xl:gap-y-5">
                    ...
                    <!-- Enrollment -->
                    <div class="row-span-1 flex flex-col">
                        <label for="Enrollment" class="text-xl">Enrollment<sup class="text-red-600">*</sup></label>
                        <input required readonly type="text" name="Enrollment" placeholder="Enter Your Enrollment" value="<?php if (isset($enroll)) { echo $enroll; } ?>" class="bg-white h-12 rounded-lg pl-3 text-lg outline-none focus:ring-2 focus:ring-indigo-800 cursor-not-allowed" id="Enrollment">
                    </div>

                    <!-- Course -->
                    <div class="row-span-1 flex flex-col">
                        <label for="Course" class="text-xl">Course<sup class="text-red-600">*</sup></label>
                        <input required readonly type="text" name="Course" placeholder="Enter Your Course" value="<?php if (isset($crs)) { echo $crs; } ?>" class="bg-white h-12 rounded-lg pl-3 text-lg outline-none focus:ring-2 focus:ring-indigo-800 cursor-not-allowed" id="Course">
                    </div>
