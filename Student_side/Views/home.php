...
<head>
    ...
    <script src="Assets/src/lottie-player.js"></script>
    <style>
...
<div id="hero_section">
        <div class="relative">
            <div class="bg-[#000]">
                <img src="Assets/images/img3.jpeg" alt="bmu" class="w-full h-[90vh] opacity-40 object-cover">
            </div>
        </div>
        <div class="text_section flex items-center justify-center">
            <div class="absolute top-32 md:top-96 lg:top-40 xl:top-56 flex flex-col items-center text-center ">
                ...
                <a href="#main"><lottie-player src="Assets/images/lottie.json" background="transparent" speed="1" loop autoplay direction="1" mode="normal" class="pb-4 animate__animated animate__zoomIn animate__fast w-[100px] h-[100px] md:w-[130px] md:h-[130px] lg:w-[100px] lg:h-[100px] lg:mt-12"></lottie-player></a>
            </div>
        </div>
        ...
        <div class="absolute bg-gray-100 w-fit h-fit flex justify-end top-36 rounded-xl hidden drop-shadow-sm" id="student_menu">
            <?php if (!isset($_SESSION['enrollment'])) { ?>
                <a href="signin">
                    <div class="flex justify-center px-3 py-2 md:px-6 md:py-4 lg:px-5 lg:py-3">
                        <img src="Assets/images/login.svg" alt="" class="w-5 md:w-8 mr-2 lg:w-6">
            ...
            <?php } else { ?>
                <a href="signout">
                    <div class="flex justify-center px-3 py-2 md:px-6 md:py-4 lg:px-5 lg:py-3">
                        <img src="Assets/images/power.svg" alt="" class="w-5 md:w-8 mr-2 lg:w-6">
    ...
    <div class="main bg-[#F7F8FC]" id="main">
        <div class="flex flex-col justify-center px-5 py-10 md:px-10 md:py-16 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:py-14 lg:gap-y-16 xl:grid-cols-3">
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="document lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl border-b-[10px] border-indigo-300" data-aos="zoom-in-up">
                    <img src="Assets/images/docuements_png.png" alt="" class="bg-indigo-300 rounded-t-xl lg:object-cover w-full h-[224px] sm:h-[390px] md:h-[458.66px] lg:h-[301.33px] object-cover">
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl md:text-3xl lg:text-2xl lg:p-4 font-medium p-3 md:p-6 col-span-1">Request For<br> Documents</p>
                        <a href="document" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:px-3 lg:py-2 lg:text-lg">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="bonafide lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-blue-300" data-aos="zoom-in-up">
                    <img src="Assets/images/bonafide.svg" alt="" class="bg-blue-300 rounded-t-xl w-full h-[224px] md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl md:text-3xl font-medium p-3 md:p-6 col-span-1 lg:text-2xl lg:p-4">Bonafide <br>Certificate</p>
                        <a href="bonafide" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="admission_cancel lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-red-400" data-aos="zoom-in-up">
                    <img src="Assets/images/admission_cancel.svg" alt="" class="bg-red-400 rounded-t-xl w-full h-[224px] md:h-[458.66px] object-cover lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2 lg:pb-5 xl:pb-0">
                        ...
                        <a href="admission_cancel" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="tc_mig_pd lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-green-400" data-aos="zoom-in-up">
                    <img src="Assets/images/tc_mg_pd.svg" alt="" class="bg-green-400 rounded-t-xl w-full h-[224px] object-cover md:h-[458.66px] lg:h-[301.33px]">
                    ...
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl col-span-1 md:text-3xl font-medium p-3 md:p-6 lg:text-2xl lg:p-4">Transfer & Provisional Certificate</p>
                        <a href="other_document" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="abroad_study lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10  lg:mt-0 border-b-[10px] border-orange-400" data-aos="zoom-in-up">
                    <img src="Assets/images/abroad_Study.svg" alt="" class="bg-orange-400 rounded-t-xl w-full h-[224px] object-cover md:h-[458.66px] lg:h-[301.33px]">
                    <!-- <div class="grid grid-flow-col grid-rows-1">
                    ...
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl col-span-1 md:text-3xl font-medium p-3 md:p-6 lg:text-2xl lg:p-4">Abroad Study<br>(Transcript & LOR)</p>
                        <a href="bonafide" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="classroom lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-teal-400" data-aos="zoom-in-up">
                    <img src="Assets/images/my_class.svg" alt="" class="bg-teal-400 rounded-t-xl w-full h-[224px] object-cover md:h-[458.66px] lg:h-[301.33px]">
                    ...
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl col-span-1 md:text-3xl font-medium p-3 md:p-6 lg:text-2xl lg:p-0">Find My Classroom</p>
                        <a href="bonafide" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Find<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="hall_ticket lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-yellow-300" data-aos="zoom-in-up">
                    <img src="Assets/images/hall_ticket.svg" alt="" class="bg-yellow-300 rounded-t-xl w-full h-[224px] object-cover md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl font-medium p-3 col-span-1 md:text-3xl md:p-6 lg:text-2xl lg:p-4">Find My <br> Hall Ticket</p>
                        <a href="document" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Find<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="exam_block lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-gray-400" data-aos="zoom-in-up">
                    <img src="Assets/images/exam_hall.svg" alt="" class="bg-gray-400 rounded-t-xl w-full h-[224px] md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2">
                        <p class="text-xl font-medium p-3 col-span-1 md:text-3xl md:p-6 lg:text-2xl lg:p-4">Find My <br>Exam Hall</p>
                        <a href="document" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-xl lg:px-3 lg:py-2">Find<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="timetable lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-purple-300" data-aos="zoom-in-up">
                    <img src="Assets/images/timetable.svg" alt="" class="bg-purple-300 rounded-t-xl w-full h-[224px] object-cover object-center md:object-none md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2">
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="id_card lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-orange-500" data-aos="zoom-in-up">
                    <img src="Assets/images/ID_Card.svg" alt="" class="bg-orange-500 rounded-t-xl w-full h-[224px] object-cover object-top md:object-cover md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2 xl:pb-7">
                        ...
                        <a href="document" class="col-span-2 flex justify-end items-end pr-4 pb-4"><button class="bg-black  flex flex-row items-center rounded-full h-fit w-fit text-white px-3 py-2 text-lg md:text-xl md:px-5 md:py-4 lg:text-lg lg:px-3 lg:py-2">Request<img src="Assets/images/link_arrow.svg" alt="" class="ml-2 md:h-6 lg:h-5"></button></a>
                    </div>
                </div>
            </div>
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="uniform lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-[#FFD684]" data-aos="zoom-in-up">
                    <img src="Assets/images/uniform.svg" alt="" class="bg-[#FFD684] rounded-t-xl w-full h-[224px] object-cover object-top md:h-[458.66px] lg:h-[301.33px]">
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="add_in_group lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-cyan-300" data-aos="zoom-in-up">
                    <img src="Assets/images/add_in_group.svg" alt="" class="bg-cyan-300 rounded-t-xl w-full h-[224px] object-cover md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-rows-1">
    ...
    <script src="Assets/src/aos.js"></script>
    <script src="Assets/src/service_worker.js"></script>
    <script>
        AOS.init();
