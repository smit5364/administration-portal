...
class external
{
    function insert($enroll, $name, $fathername, $course, $sem, $mobile, $email,  $document_tc, $document_migration, $document_pdc, $savefilename)
    {
        $conn = connect();
        $sql = "INSERT INTO `external_study`(`enrollment_no`, `name`, `father_name`, `course`,  `semester` ,  `mobile_no` ,  `email` , `document_tc`,`document_migration`,`document_pdc`, `marksheet`, `apply_date`) VALUES ('$enroll','$name','$fathername','$course','$sem','$mobile','$email','$document_tc','$document_migration','$document_pdc','$savefilename', curdate())";
