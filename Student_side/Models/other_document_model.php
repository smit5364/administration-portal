...
{
    function insert($enroll, $name, $fathername, $course, $sem, $mobile, $email,  $document_tc, $document_pdc, $savefilename)
    {
        $conn = connect();
        $sql = "INSERT INTO `other_document`(`enrollment`, `name`, `father_name`, `course`,  `semester` ,  `mobile_no` ,  `email` , `document_tc`,`document_pdc`, `marksheet`, `apply_date`) VALUES ('$enroll','$name','$fathername','$course','$sem','$mobile','$email','$document_tc','$document_pdc','$savefilename', curdate())";
