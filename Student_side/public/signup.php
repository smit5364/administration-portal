        ...
        <div class="bg-gray-100 w-fit rounded-xl shadow-lg">
            ...
            <form action="" method="post" id="signup_form">
                ...
                <div class="flex justify-end items-center pr-10 py-5">
                    <div class="text-lg font-medium mr-[15.5rem] text-gray-500">
                        ...
                        if (check == 1) {
                            ...
                            if (pass == confirm_password) {
                                jQuery.ajax({
                                    url: 'private/signup_server.php',
                                    type: 'POST',
                                    data: '&insert=' + 'true' + '&fname=' + fname + '&mname=' + mname + '&lname=' + lname + '&father=' + father + '&course=' + course + '&sem=' + semester + '&enrollment=' + enrollment + '&email=' + email + '&mobile=' + mobile + '&pass=' + pass,
                                    success: function() {
