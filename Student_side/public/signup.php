        ...
        <div class="bg-gray-100 w-fit rounded-xl shadow-lg">
            ...
            <div class="grid grid-cols-3 px-10 py-4 gap-x-10">
                ...
                <div class="flex flex-col w-72">
                    ...
                    <input type="text" name="semester" id="semester" placeholder="Enter Your Semester" class="h-12 rounded-lg text-lg pl-2 focus:ring-2 focus:outline-none outline-none focus:ring-offset-2 focus:ring-indigo-800" required>
                </div>
            </div>
            <div class="grid grid-cols-3 px-10 py-4 gap-x-10">
                <div class="flex flex-col w-72">
