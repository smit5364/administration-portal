...
<head>
    ...
    <script src="private/src/lottie-player.js"></script>
    <style>
...
<body class="bg-gray-200" style="font-family: 'Geologica', sans-serif; -webkit-tap-highlight-color: transparent;">
    <div class="navbar">
        <nav class="bg-white w-full h-14">
            <ul class="flex items-center justify-between pt-1">
                <li><a href="home" class="flex"><img src="private/assets/images/BMCCA_logo.png" alt="" class="object-cover w-12 mx-1"><img src="private/assets/images/Bhagwan Mahavir College of Computer Application.svg" alt="" class="md:ml-2"></a></li>
                <li id="btn_student"><?php if (!isset($_SESSION['enrollment'])) { ?>
                        <img src="private/assets/images/user.svg" alt="" class="w-12 mx-1 cursor-pointer" />
                    <?php } else { ?>
                        <img src="private/assets/letters_images/d.svg" alt="" class="w-12 mx-1 cursor-pointer">
                    <?php } ?>
                </li>
            </ul>
        </nav>
    ...
    <div id="hero_section">
        <div class="relative">
            <div class="bg-[#000]">
                <img src="private/assets/images/img3.jpeg" alt="bmu" class="w-full h-[90vh] opacity-40 object-cover">
            </div>
        </div>
        <div class="text_section flex items-center justify-center">
            <div class="absolute top-32 md:top-96 lg:top-40 xl:top-56 flex flex-col items-center text-center ">
                ...
                <a href="#main"><lottie-player src="private/assets/images/lottie.json" background="transparent" speed="1" loop autoplay direction="1" mode="normal" class="pb-4 animate__animated animate__zoomIn animate__fast w-[100px] h-[100px] md:w-[130px] md:h-[130px] lg:w-[100px] lg:h-[100px] lg:mt-12"></lottie-player></a>
            </div>
        </div>
            ...
            <?php if (!isset($_SESSION['enrollment'])) { ?>
                <a href="signin">
                    <div class="flex justify-center px-3 py-2 md:px-6 md:py-4 lg:px-5 lg:py-3">
                        <img src="private/assets/images/login.svg" alt="" class="w-5 md:w-8 mr-2 lg:w-6">
        ...
        <div class="flex flex-col justify-center px-5 py-10 md:px-10 md:py-16 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:py-14 lg:gap-y-16 xl:grid-cols-3">
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="document lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl border-b-[10px] border-indigo-300" data-aos="zoom-in-up">
                    <img src="private/assets/images/docuements_png.png" alt="" class="bg-indigo-300 rounded-t-xl lg:object-cover w-full h-[224px] sm:h-[390px] md:h-[458.66px] lg:h-[301.33px] object-cover">
            ...
            <div class=" transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl rounded-xl">
                <div class="bonafide lg:p-3 xl:p-0 bg-white shadow-xl rounded-xl mt-10 lg:mt-0 border-b-[10px] border-blue-300" data-aos="zoom-in-up">
                    <img src="private/assets/images/bonafide.svg" alt="" class="bg-blue-300 rounded-t-xl w-full h-[224px] md:h-[458.66px] lg:h-[301.33px]">
                    <div class="grid grid-flow-col grid-cols-2">
        ...
        <div class="bg-indigo-300 grid grid-rows-2 md:grid-rows-1 py-3 xl:py-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 md:mt-6">
                <div class="col-span-1 flex flex-col items-center justify-center">
                    <a href="https://www.facebook.com/BMCOCA" target="_blank"><img src="private/assets/images/facebook.png" alt="" class="w-[90px] md:w-[110px]"></a>
                </div>
                <div class="col-span-1 flex flex-col items-center justify-center">
                    <a href="https://www.instagram.com/bmu.bmcca/" target="_blank"><img src="private/assets/images/instagram.png" alt="" class="w-[80px] md:w-[100px]"></a>
                </div>
                <div class="col-span-1 hidden md:flex flex-col items-center justify-center">
                    <a href="https://www.linkedin.com/company/bmcoca/" target="_blank"><img src="private/assets/images/linkedin.png" alt="" class="w-[80px] md:w-[100px]"></a>
                </div>
                <div class="col-span-1 hidden md:flex flex-col items-center justify-center">
                    <a href="https://twitter.com/bmcocasurat" target="_blank"><img src="private/assets/images/twitter.png" alt="" class="w-[80px] md:w-[100px]"></a>
                </div>
            </div>
            <div class="grid grid-cols-2 pt-2 md:hidden">
                <div class="col-span-1 flex flex-col items-center justify-center">
                    <a href="https://www.linkedin.com/company/bmcoca/" target="_blank"><img src="private/assets/images/linkedin.png" alt="" class="w-[80px]"></a>
                </div>
                <div class="col-span-1 flex flex-col items-center justify-center">
                    <a href="https://twitter.com/bmcocasurat" target="_blank"><img src="private/assets/images/twitter.png" alt="" class="w-[80px]"></a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="private/src/aos.js"></script>
    <script>
        AOS.init();
