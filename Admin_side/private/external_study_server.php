...
class external
{
    ...
    {
        $con = connect();
        $sql = "SELECT * FROM `external_study` WHERE id = ? LIMIT 1";
        ...
        // }
        // print flag update
        $query = "UPDATE `external_study` SET `print_flag` = '1' WHERE `id` = '$id'";
    ...
    {
        $con = connect();
        $query = "SELECT * FROM `external_study` ORDER BY id DESC";
    ...
    {
        $con = connect();
        $query = "SELECT * FROM `external_study` WHERE `id` = '$id'";
        $result = mysqli_query($con, $query);
        return $result;
    }
    ...
    {
        $con = connect();
        $query = "UPDATE `external_study` SET `verify_flag`='1',`verify_by`='$_SESSION[name]' WHERE id = '$id'";
        $result = mysqli_query($con, $query);
        if ($result) {
    ...
    {
        $con = connect();
        $query = "UPDATE `external_study` SET `approve_flag`='1',`approve_by`='$_SESSION[name]' WHERE id = '$id'";
        $result = mysqli_query($con, $query);
        if ($result) {
        ...
        // $this->sendmail($id);
        header('location:external_study');
    }

    function cancel_verify($id, $remark)
    {
        $con = connect();
        $query = "UPDATE `external_study` SET `remark`='$remark' WHERE `id` = '$id'";
        mysqli_query($con, $query);
    ...
    {
        $con = connect();
        $query = "SELECT COUNT(*) FROM `external_study` WHERE `verify_flag` = '0' AND `remark` = ''";
        $result = mysqli_query($con, $query);
    ...
    {
        $con = connect();
        $query = "SELECT COUNT(*) FROM `external_sutdy` WHERE `approve_flag` = '0' AND `verify_flag` = '1' AND `remark` = ''";
        $result = mysqli_query($con, $query);
        // $data = mysqli_fetch_assoc($result);
        // return $data['COUNT(*)'];
    }
    ...
    {
        $con = connect();
        $query = "SELECT COUNT(*) FROM `external_sutdy` WHERE `remark` != ''";
        $result = mysqli_query($con, $query);
        $data = mysqli_fetch_assoc($result);
        return $data['COUNT(*)'];
    }
    ...
    {
        $con = connect();
        $query = "SELECT COUNT(*) FROM `external_study` WHERE `delever_flag` = '1' AND `remark` = ''";
        $res = mysqli_query($con, $query);

        if (!$res) {
            // Handle query execution error.
            echo "Query execution error: " . mysqli_error($con);
            return -1; // or any other error code to indicate a failure.
        }
    ...
    {
        $con = connect();
        $query = "UPDATE `external_sutdy` SET `delever_flag`='1', `pickup_date`= curdate() WHERE `id` = '$id'";
        $result = mysqli_query($con, $query);
        if ($result) {
    ...
    //     {
    //         $con = connect();
    //         $sql = "SELECT * FROM `external_sutdy` WHERE id = ? LIMIT 1";
    //         $stmt = mysqli_prepare($con, $sql);
    //         if ($stmt) {
    //             mysqli_stmt_bind_param($stmt, "i", $id);
    //             mysqli_stmt_execute($stmt);
