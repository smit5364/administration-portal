...
<body class="m-0 font-sans text-base antialiased font-normal bg-gray-50 text-slate-500 overflow-hidden">
    ...
    <section class="fixed inset-y-0 flex-wrap items-center justify-between w-1/5 p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl max-w-64 ease-in-out z-[990] xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0">
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="w-full">
                    <a href="admission_cancel" class="text-lg my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 py-3 font-medium text-slate-700 transition-colors">
                        <i class="ni ni-tv-2 text-indigo-600 mr-3"></i>
                        Admission Cancle
                    </a>
                </li>
                <li class="w-full">
                    <a href="external_study" class="bg-indigo-200 text-lg my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 py-3 font-medium text-slate-700 transition-colors">
                        <i class="ni ni-tv-2 text-indigo-600 mr-3"></i>
                        External Study
                    </a>
                </li>
            ...
            <div class="flex w-full 2xl:px-4 py-1 mx-auto flex-wrap-inherit">
                <nav class="xl:pl-80">
                    ...
                    <ol class="flex flex-wrap pt-1 bg-transparent rounded-lg">
                        ...
                        <li class="text-base pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">External Study</li>
                    </ol>
                    <h6 class="mb-0 font-bold text-white capitalize text-lg">External Study</h6>
                </nav>
        ...
        <div class="w-full py-3 px-4 2xl:w-4/5 2xl:px-6 2xl:pt-8 xl:ml-80">
            ...
            ?>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <!-- card1 -->
                    <div class="w-full max-w-full px-3 mb-3 2xl:mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4 cursor-pointer" id="pending_verify">
                                    ...
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            ...
                                            <h5 class="mb-2 font-bold text-2xl">
                                                <?php echo $external->pending_verify(); ?>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-row -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            ...
                                            <h5 class="mb-2 font-bold text-2xl">
                                                <?php echo $external->pending_approval(); ?>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="px-3 text-right basis-1/3">
                                ...
                                <div class="flex flex-row -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            ...
                                            <h5 class="mb-2 font-bold text-2xl">
                                                <?php echo $external->complete_deliver(); ?>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="px-3 text-right basis-1/3">
            ...
            <div class="min-w-full bg-white shadow-lg rounded-2xl mt-0 py-4">
                <div class="flex flex-col justify-start">
                    <h1 class="text-2xl font-medium text-indigo-600 py-2 pl-3">External Study Verification</h1>
                </div>
                <div class="px-4 min-w-full text-left text-base mt-2 overflow-x-auto">
                    <table id="myTable">
                        <thead class="border-b font-medium text-lg">
                            <tr>
                                <th scope="col" class="px-3 py-2">Sr.No</th>
                        ...
                        <tbody class="text-left">
                            ...
                            <?php
                            $get_deatils = $external->get_details();
                            $count = 0;
                                ...
                                <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 2xl:text-lg">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <?php if ($_SESSION['type'] == "Clerk" && $row['verify_flag'] == 0 && $row['remark'] == "") { ?>
                                            <button name="view" id="view" class="bg-indigo-600 px-4 py-2 rounded-lg text-white font-medium hover:bg-indigo-500 shadow-md" onclick="verify(<?php echo htmlspecialchars($row['id']); ?>)">View</button>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <?php if ($_SESSION['type'] == "Head" && $row['verify_flag'] == 1 && $row['approve_flag'] == 0 && $row['remark'] == "") { ?>
                                            <button name="approve" onclick="verify(<?php echo htmlspecialchars($row['id']); ?>)" id="approve" class="bg-indigo-600 px-4 py-2 rounded-lg text-white font-medium hover:bg-indigo-500 shadow-md">View</button>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <?php if ($row['approve_flag'] == 1 && $_SESSION['type'] == "Clerk" && $row['delever_flag'] == 0 && $row['remark'] == "") { ?>
                                            <div class="flex"> <a href="private/document_server.php?pickup_id=<?php echo htmlspecialchars($row['id']); ?>"><button class="bg-indigo-600 px-4 py-2 rounded-lg text-white font-medium hover:bg-indigo-500 shadow-md deliver">Deliver</button></a>
                                            </div>
                                    ...
                                    <!-- <td class="whitespace-nowrap px-6 py-4">
                                        <?php if ($row['delever_flag'] == 1 && $_SESSION['type'] == "Clerk" && $row['remark'] == "" && $row['return_flag'] == 0) { ?>
                                            <div class="flex"> <a href="private/document_server.php?return_date=<?php echo htmlspecialchars($row['id']); ?>"><button class="bg-indigo-600 px-4 py-2 rounded-lg text-white font-medium hover:bg-indigo-500 shadow-md">Return</button></a>
                                            </div>
                                        <?php } else if ($_SESSION['type'] == "Head" && $row['delever_flag'] == 0 && $row['remark'] == "") { ?>
                                            <div class="flex">
                                                <p class="text-base bg-yellow-600 mr-3 py-1 px-2 text-white font-medium text-center rounded-full">
    ...
    <script>
        ...
        function verify(id) {
            jQuery.ajax({
                url: 'private/external_sutdy_server.php',
                type: 'POST',
                data: "&id=" + id,
                success: function(response) {
                    // console.log(response);
                    window.location.href = "external_study_verification";
                }
            })
        }
    </script>
