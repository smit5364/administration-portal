...
$external_details = $external->individual_detail($id);

if (isset($_POST['verify'])) {
    $external->update_verify($id);
    header('location:external_sutdy');
}
if (isset($_POST['approve'])) {
    $external->approve_verify($id);
    header('location:external_sutdy');
}
?>
<!DOCTYPE html>
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav class="pl-80">
                    ...
                    <ol class="flex flex-wrap pt-1 bg-transparent rounded-lg">
                        ...
                        <li class="text-md pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">external Study</li>
                    </ol>
        ...
        <div class="w-4/5 px-6 py-8 ml-80">
            ...
            ?>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <!-- card3 -->
                    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4 cursor-pointer" onclick="reject_document()">
                        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl rounded-2xl bg-clip-border">
                            <div class="flex-auto p-4">
                                <div class="flex flex-row -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            ...
                                            <h5 class="mb-2 font-bold text-2xl">
                                                <?php echo $external->reject_document(); ?>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="px-3 text-right basis-1/3">
            ...
            <div class="w-full bg-white shadow-2xl rounded-2xl mt-0 py-4">
                ...
                <div class="flex flex-col justify-start px-5">
                    <?php
                    while ($row = mysqli_fetch_assoc($external_details)) {
                    ?>
                        ...
                        <div class="grid grid-cols-3 mt-6">
                            <div class="col-span-1">
                                ...
                                <p class="text-lg">
                                    <?php $external = array();
                                    if ($row['document_tc'] === '1') {
                                        $external[] = "Transfer Certificate Certificate";
                                    }
                                    if ($row['document_migration'] === '1') {
                                        $external[] = "Migration Certificate";
                                    }
                                    if ($row['document_pdc'] === '1') {
                                        $external[] = "Provisional Degree Certificate";
                                    }
                                    $doc = implode(', ', $external);
                                    echo $doc; ?>
                                </p>
                            </div>
                            <!-- <div class="col-span-1">
                        ...
                        <div class="grid grid-cols-3 mt-6">
                            ...
                            <div class="col-span-1">
                                <h1 class="text-lg font-medium">Marksheet</h1>
                                <p class="text-lg flex items-center">
                                    <a href="private/marksheet/<?php echo htmlspecialchars($row['marksheet']); ?>" target="_blank">
